<%@ Page Title="" Language="C#" MasterPageFile="~/Users.Master" AutoEventWireup="true" CodeBehind="EditSaverItem.aspx.cs" Inherits="Contracting_System.EditSaverItem" %>
...
<script type="text/jscript">
    $(function () {
        ...
        $("#btn_Save").on("click", function () {
            if ($("#txt_SaverItem").val() != '' && $("#cbo_SaverItem").val() != '') {
                $.ajax({
                    url: "SaveData.aspx",
                    type: "POST",
                    data: {
