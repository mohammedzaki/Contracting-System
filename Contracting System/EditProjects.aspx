<%@ Page Title="" Language="C#" MasterPageFile="Users.master" AutoEventWireup="true"
    CodeBehind="EditProjects.aspx.cs" Inherits="Contracting_System.EditProjects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="UsersMainContent" runat="server">
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tab-2">بنود المقايسة</a></li>
            <li><a href="#tab-3">مقاولى الباطن</a></li>
            <li><a href="#tab-4">عمالة المشروع</a></li>
            <li><a href="#tab-5">موظفين المشروع</a></li>
        </ul>
        <div id="tab-1">
            <br />
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="txt_ProjectStartDate1" readonly="readonly"/>
                    </td>
                    <td class="style23">
                        تاريخ استلام الموقع :
                    </td>
                    <td>
                        <input type="text" id="txt_ReceptionLocationDate1" readonly="readonly"/>
                    </td>
                </tr>
                <tr>
                    <td class="style23">
                    ...
                    <td>
                        <input type="text" id="txt_ProjectStartTechnicalDate1" readonly="readonly"/>
                    </td>
                    <td class="style23">
                        تاريخ انتهاء المشروع :
                    </td>
                    <td>
                        <input type="text" id="txt_ProjectEndDate1" readonly="readonly"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align: center;">
                        <input id="btn_SaveProjectData" type="button" value="تعديل" onclick="SaveProjectData()"
                            class="btn_Save" />
                        <input id="btn_CancelSaveProjectData" type="button" value="إغلاق المشروع" class="btn_Save" onclick="CloseProject()" />
        ...
        <div id="tab-2">
            ...
            <div>
                <table>
                    ...
                    <tr style="background-color: rgb(108, 180, 247)">
                        <td class="style23">
                            <label>
                        ...
                        <td>
                            <input type="button" value="بند جديد" onclick="toggleContent()"/>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4" class="style29">
                            <div ID="content" hidden="">
                                <table style="border: 5px; border-style: solid">
                                    <tr>
                                        <td class="style23">
                                            <label>اسم البند :</label>
                                        </td>
                                        <td>
                                           <input id="txt_NewEstemation" type="text"/> 
                                        </td>
                                         <td style="text-align:center"><b>المعادلات المضافة</b></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txt_EstimationUnit" type="text"/>
                                        </td>
                                        <th rowspan="5">
                           <select  id="lst_addedEquation" multiple="multiple">
                               <option>لا يوجد معادلات </option>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <input id="txt_Quantity" class="IsNumberOnly" type="text"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style23">
                                            <label>سعر الكمية :</label>
                                        </td>
                                        <td>
                                            <input id="txt_QuantityPrice" class="IsNumberOnly" type="text"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="style29">
                                            <input id="btn_AddNewEstimation" type="button" style="width: 100px" value="إضافة" onclick="AddNewEstimation()"/>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <tr>
                        <td></td>
                        <td class="style23"><input type="button" value="تطبيق المعادلة" onclick="ApplyEstimation()"/></td>
        ...
        <div id="tab-3">
            ...
            <input id="btn_SaveNewSubContractor" type="button" value="إضافه" onclick="SaveNewSubContractor()"
                class="btn_Save" />
            <%--<input id="btn_CancelSaveNewSubContractor" type="button" value="حذف" class="btn_Save" onclick="toggleDeleteSubcontractor()"/>--%>
        ...
        <div id="tab-4">
            ...
            <input id="Button8" type="button" value="حذف" class="btn_Save" />
            <table>
                <thead>
                    <tr class="HeaderRow">
                        <td class="style16">
        ...
        <div id="tab-5">
            ...
            <%--<input id="Button10" type="button" value="حذف" class="btn_Save" />--%>
            <table>
                <thead>
                    <tr class="HeaderRow">
                        <td class="style16">
                ...
                <tbody id="grid_Employee">
                    <tr class="ItemRow">
                        ...
                        <%--<td class="tbl_td_buttonRemove">
                            <input type="button" value="             " style="background-color: silver; border: silver;" />
                        </td>--%>
                    </tr>
                </tbody>
            </table>
    ...
    <script type="text/javascript">
        ...
        //checklistbox($("#Cbo_SubContractorWorkType"));
        //$("#Cbo_SubContractorWorkType").checklistbox();
    ...
    <script src="js/EditProjects.js" type="text/javascript"></script>
</asp:Content>
