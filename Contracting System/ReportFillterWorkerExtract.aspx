<%@ Page Title="" Language="C#" MasterPageFile="~/Users.Master" AutoEventWireup="true" CodeBehind="ReportFillterWorkerExtract.aspx.cs" Inherits="Contracting_System.ReportFillterWorkerExtract" %>
...
<script>
    ...
    function Print() {
        window.location.href = "ReportViewer.aspx?Report=4&ExractOrder=" + $("#ex").val() + "&ProjectID=" + $("#cbo_ProjectName").val() + "&PersonID=" + $("#Select1").val();
    }
</script>
</asp:Content>
