<%@ Page Title="" Language="C#" MasterPageFile="~/Users.Master" AutoEventWireup="true" CodeBehind="AddExpenseCategory.aspx.cs" Inherits="Contracting_System.AddExpenseCategory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="UsersheadContent" runat="server">
<script type="text/jscript">
    $(function () {
        $("#btn_Save").on("click", function () {
            if ($("#txt_ExpensesCategory").val() != '') {
                $.ajax({
                    url: "SaveData.aspx",
                    type: "POST",
                    data: {
                        Name: $("#txt_ExpensesCategory").val(),
...
<table>
        <tr>
            ...
            <td>
                <input id="txt_ExpensesCategory" type="text"/>
            </td>
        </tr>
        <tr>
