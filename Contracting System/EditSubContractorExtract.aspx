<%@ Page Title="" Language="C#" MasterPageFile="~/Users.Master" AutoEventWireup="true"
    CodeBehind="EditSubContractorExtract.aspx.cs" Inherits="Contracting_System.EditSubContractorExtract" %>
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#cbo_ProjectName").on("change", function () {
                        $("#cbo_SubContractor").html('<option></option>');
                    ...
                    $("#cbo_SubContractor").on("change", function () {
                        ...
                        $(subData).filter('main').find('Tbl_SubContractorExtract').each(function () {
                    ...
                    $("#cbo_ExractOrder").on("change", function () {
                        ...
                        $(subData).filter('main').find('Tbl_SubContractorExtract').each(function () {
                            if ($(this).find('PK_ID').text() == $("#cbo_ExractOrder").val()) {
                                ...
                                $(subData).filter('main').find('Tbl_SubContractorExtractItems').each(function () {
                                    if ($(this).find('FK_SubContractorExractID').text() == $("#cbo_ExractOrder").val()) {
        ...
        function SaveSubContractorExtract() {
            if ($("#cbo_Employee").val() != '') {
                ...
                xmlSubContractorExtract += "<SubContractorExractPK_ID>" + $("#cbo_ExractOrder").val() + "</SubContractorExractPK_ID>";
                xmlSubContractorExtract += "</SubContractorExtractInfo>";
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    xmlSubContractorExtract += "<ExtractItemPK_ID>" + ExtractItemPK_ID + "</ExtractItemPK_ID>";
                    xmlSubContractorExtract += "</Item>";
                }
                xmlSubContractorExtract += "</SubContractorExtractItems>";
                ...
                $.ajax({
                    ...
                    url: "SaveData.aspx/UpdateSubContractorExtract",
                    dataType: "json",
                    success: function (data) {
                        if (data.d > -1) {
    ...
    <table>
        <tr>
            <td colspan="4" class="td_center">
                <h1>
                    تعديل مستخلص مقاولين الباطن</h1>
            </td>
        </tr>
        <tr>
            <td class="style23">
