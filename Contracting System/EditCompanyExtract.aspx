<%@ Page Title="" Language="C#" MasterPageFile="~/Users.Master" AutoEventWireup="true"
    CodeBehind="EditCompanyExtract.aspx.cs" Inherits="Contracting_System.EditCompanyExtract" %>
        ...
        $(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#grid_ExtractDetails").html('<tr class="ItemRow"><td class="style16"><input name="WorkItem" class="b_width addrow" readonly/></td><td class="style22"><input name="QTY" class="s_width addrow" readonly/></td><td class="style18"><input name="Price" class="s_width addrow" onchange="onChangePrice(this)"/></td><td class="style18"><input type="text" name="unit" class="s_width addrow" onchange="onChangePrice(this)"/></td><td class="style18"><input type="text" name="LastDoneQTY" class="s_width addrow" onchange="onChangePrice(this)" readonly/></td><td class="style18"><input type="text" name="CurrentDoneQTY" class="s_width addrow" onchange="onChangePrice(this)"/></td><td class="style18"><input type="text" name="TotalDoneQTY" class="s_width addrow" readonly/></td><td class="style18"><input type="text" name="TotalPrice" class="s_width addrow" readonly/></td></tr>');
                    ...
                    $("#cbo_ProjectName").on("change", function () {
                        ...
                        $(subData).filter('main').find('Tbl_CompanyExract').each(function () {
                    ...
                    $("#cbo_ExractOrder").on("change", function () {
                        ...
                        $(subData).filter('main').find('Tbl_CompanyExract').each(function () {
                            if ($(this).find('PK_ID').text() == $("#cbo_ExractOrder").val()) {
                                ...
                                $(subData).filter('main').find('Tbl_CompanyExractItems').each(function () {
                                    if ($(this).find('FK_CompanyExractID').text() == $("#cbo_ExractOrder").val()) {
                                        $("#grid_ExtractDetails").append('<tr class="ItemRow"><td class="style16"><input name="WorkItem" class="b_width addrow" value="' + $(this).find('EstimationName').text() + '" readonly/></td><td class="style22"><input name="QTY" class="s_width addrow" value="' + $(this).find('EstimationQTY').text() + '" readonly/></td><td class="style18"><input name="Price" class="s_width addrow" value="' + $(this).find('Price').text() + '" onchange="onChangePrice(this)"/></td><td class="style18"><input type="text" name="unit" class="s_width addrow" value="' + $(this).find('Unit').text() + '" onchange="onChangePrice(this)"/></td><td class="style18"><input type="text" name="LastDoneQTY" class="s_width addrow" value="' + $(this).find('LastExitExecutedQTY').text() + '" onchange="onChangePrice(this)" readonly/></td><td class="style18"><input type="text" name="CurrentDoneQTY" class="s_width addrow" value="' + $(this).find('CurrentExecutedQTY').text() + '" onchange="onChangePrice(this)"/></td><td class="style18"><input type="text" name="TotalDoneQTY" class="s_width addrow" value="' + $(this).find('TotalExecutedQTY').text() + '" readonly/></td><td class="style18"><input type="text" name="TotalPrice" class="s_width addrow" value="' + $(this).find('TotalPrice').text() + '" readonly/></td><td style="display: none;"><input type="hidden" name="PK_ID" class="s_width addrow" value="' + $(this).find('PK_ID').text() + ' readonly/></td></tr>');
                                    }
                                });
                                calcuPrice();
                            }
        ...
        */
        ...
        function SaveCompanyExtract() {
            if ($("#cbo_Employee").val() != '') {
                ...
                xmlCompanyExtract += "<CompanyExractPK_ID>" + $("#cbo_ExractOrder").val() + "</CompanyExractPK_ID>";
                xmlCompanyExtract += "</CompanyExtractInfo>";
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    ExtractItemPK_ID = $('#grid_ExtractDetails tr:eq(' + i + ') td:eq(8)').children(0).val();
                    ...
                    xmlCompanyExtract += "<ExtractItemPK_ID>" + ExtractItemPK_ID + "</ExtractItemPK_ID>";
                    xmlCompanyExtract += "</Item>";
                }
                xmlCompanyExtract += "</CompanyExtractItems>";
                ...
                $.ajax({
                    ...
                    url: "SaveData.aspx/UpdateCompanyExtract",
                    dataType: "json",
                    success: function (data) {
                        if (data.d > -1) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="UsersMainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="txt_Supervisor" class="IsNumberOnly b_width" readonly />
            </td>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tbody id="grid_ExtractDetails">
            <tr class="ItemRow">
                <td class="style16">
                    <input name="WorkItem" class="b_width addrow" readonly />
                </td>
                <td class="style22">
