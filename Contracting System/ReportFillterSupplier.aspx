<%@ Page Title="" Language="C#" MasterPageFile="~/Users.Master" AutoEventWireup="true" CodeBehind="ReportFillterSupplier.aspx.cs" Inherits="Contracting_System.ReportFillterSupplier" %>
...
<script>
    ...
    function Print() {
        window.location.href = "ReportViewer.aspx?Report=2&ExractOrder=" + $("#ex").val() + "&ProjectID=" + $("#cbo_ProjectName").val() + "&PersonID=" + $("#Select1").val();
    }
</script>
</asp:Content>
